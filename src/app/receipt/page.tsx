...
function ReceiptContent() {
    ...
    return (
        <div className="max-w-md mx-auto">
            {orderDetails ? (
                <div
                    className="bg-white border border-gray-200 shadow-sm p-8 font-mono text-sm leading-relaxed mb-8 rounded-lg"
                    id="receipt-content"
                >
                    <div className="text-center mb-6 border-b border-dashed border-gray-400 pb-4">
                        <h2 className="text-2xl font-bold text-[#3e2723] mb-2 font-sans">
                            Lumeria
                        </h2>
                        <p className="text-gray-600">Telkom University Jakarta Kampus 1</p>
                        <p className="text-gray-600">
                            Jl. Daan Mogot KM 11, Jakarta Barat
                        </p>
                        <p className="text-gray-600">Telp: +62 8897 6183 041</p>
                    </div>
                    ...
                    <div className="border-t border-b border-dashed border-gray-400 py-4 mb-6">
                        <h4 className="text-center font-bold text-[#3e2723] mb-4 text-base font-sans">
                            Item Pesanan:
                        </h4>
                        <div className="space-y-3">
                            {orderDetails.items.map((item: any, i: number) => (
                                <div
                                    key={i}
                                    className="flex justify-between border-b border-dotted border-gray-200 pb-2 last:border-0"
                                >
                ...
                <div className="bg-white p-8 rounded-lg shadow-sm text-center">
                    <p className="text-red-500 mb-4">
                        Tidak ada detail pesanan yang ditemukan untuk ID:{" "}
                        {orderId || "Tidak diketahui"}
                    </p>
