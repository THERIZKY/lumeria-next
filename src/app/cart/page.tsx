                ...
                {cartItems.length === 0 ? (
                    <div className="text-center py-12 bg-white rounded-lg shadow-sm">
                        <p className="text-xl text-gray-600 mb-6">
                            Keranjang Anda kosong. Yuk pesan sekarang.
                        </p>
                        <Link href="/menu">
                                ...
                                {cartItems.map((item) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            {item.Category !== "Rice Bowl" && item.Category !== "Minuman" && (
                                                <div className="mt-2">
                                                    <Select
                                                        value={item.topping || "none"}
                                                        onValueChange={(v) => updateTopping(item.ID, v === "none" ? "" : (v as string))}
                                                    >
                                                        <SelectTrigger className="w-[180px] h-8 text-xs border-gray-300 bg-white">
                                                            <SelectValue placeholder="Pilih Topping (Opsional)" />
                                                        </SelectTrigger>
                                                        <SelectContent>
                            ...
                            <div className="grid gap-4">
                                <div className="grid gap-2">
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value="alamat">
                                                Tulis Alamat
                                            </SelectItem>
                                            <SelectItem value="ambil">
                                                Ambil di Tempat
                                            </SelectItem>
                                        </SelectContent>
                                    </Select>
